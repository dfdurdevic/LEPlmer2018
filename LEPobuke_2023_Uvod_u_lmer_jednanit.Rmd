---
title: "LEPobuke_2023: Uvod u analizu mešovitih efekata"
...
# pobrinemo se za tip podataka

```{r, warning = FALSE, message = FALSE}
dat.im$Subject = as.factor(dat.im$Subject)
dat.im$Leksikalnost = as.factor(dat.im$Leksikalnost)
dat.im$Viseznacnost  = as.factor(dat.im$Viseznacnost )
dat.im$Rec = as.factor(dat.im$Rec)
```
...
- postoje različite transformacije
- za sada ćemo primeniti logaritamsku transformaciju RT
```{r, warning = FALSE, message = FALSE}
